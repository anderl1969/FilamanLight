...
// bool saveBambuCredentials(const String &ip, const String &serialnr,
//                           const String &accesscode, bool autoSend,
//                           const String &autoSendTime) {
//   if (BambuMqttTask) {
//     vTaskDelete(BambuMqttTask);
//     BambuMqttTask = NULL;
//   }
...
//   preferences.putBool(NVS_KEY_BAMBU_AUTOSEND_ENABLE,
//                       bambuCredentials.autosend_enable);
//   preferences.putInt(NVS_KEY_BAMBU_AUTOSEND_TIME,
//                      bambuCredentials.autosend_time);
//   preferences.end();
//
...
//   bool autosendEnable =
//       preferences.getBool(NVS_KEY_BAMBU_AUTOSEND_ENABLE, false);
//   int autosendTime = preferences.getInt(NVS_KEY_BAMBU_AUTOSEND_TIME,
//                                         BAMBU_DEFAULT_AUTOSEND_TIME);
//   preferences.end();
//
//   if (ip != "") {
//     bambuCredentials.ip = ip.c_str();
